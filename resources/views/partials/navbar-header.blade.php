                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div
                            ...
                            <div>
                                @auth('admin')
                                    <h6 class="text-lg text-primary-light fw-semibold mb-2">{{auth('admin')->user()->name ?? 'Admin'}}</h6>
                                    <span class="text-secondary-light fw-medium text-sm">{{auth('admin')->user()->role->name ?? '-'}}</span>
                                @endauth
                                    ...
                                    <li>
                                        <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3"
                                           href="{{ config('bridge.agent_portal.dashboard_url') }}">
                                            <iconify-icon icon="solar:arrow-left-linear" class="icon text-xl"></iconify-icon> Back to {{ \App\Support\Brand::for(auth('employee')->user())['name'] ?? 'Agent' }} Dashboard</a>
                                    </li>
                                @endif
                            @endauth
{{--                            <li>--}}
