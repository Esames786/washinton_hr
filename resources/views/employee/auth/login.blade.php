...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="{{ asset(\App\Support\Brand::current()['logo'] ?? 'assets/images/logo/hello_transport.png') }}">
    <!-- remix icon font css  -->
        ...
        <div class="login-container max-w-464-px mx-auto w-100">
            <div>
                <a href="{{route('admin.login')}}" class="mb-40" style="margin-left: 35%">
                    <img src="{{asset(\App\Support\Brand::current()['logo'] ?? 'assets/images/logo/hello_transport.png')}}" alt="{{ \App\Support\Brand::current()['name'] ?? 'Company' }}" class="logo-width-100">
                </a>
