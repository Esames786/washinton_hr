...
<div class="payslip-container">
    ...
    <table class="salary-info">
        <tr><th>Basic Pay</th><td>{{ number_format($payrollDetail->basic_salary, 2) }}</td></tr>
        ...
        <tr class="net-salary"><th>Net Pay</th><td>PKR {{ number_format($payrollDetail->net_salary, 2) }}</td></tr>
    </table>
