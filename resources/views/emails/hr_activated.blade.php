      ...
      <tr>
        <td style="padding:36px 40px;">
            ...
            <tr>
              <td style="background:#f0fdfa;border:1px solid #99f6e4;border-radius:8px;padding:20px 24px;">
                ...
                <p style="margin:0 0 16px;color:#555;font-size:13px;">
                  <a href="https://hr.hellotransport.com/subcontractor/login" style="color:#062e39;word-break:break-all;">
                    https://hr.hellotransport.com/subcontractor/login
                  </a>
                </p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr>
              <td align="center">
                <a href="https://hr.hellotransport.com/subcontractor/login"
