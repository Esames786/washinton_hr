...
class HrSettingSeeder extends Seeder
{
    public function run()
    {
        DB::table('hr_employment_types')->truncate();
        ...
        DB::table('hr_employee_statuses')->truncate();
        DB::table('hr_employee_statuses')->insert([
        ...
        DB::table('hr_commission_types')->truncate();
        DB::table('hr_commission_types')->insert([
            ['id' => 1, 'name' => 'Percentage', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 2, 'name' => 'Fixed',       'created_at' => now(), 'updated_at' => now()],
        ]);

        DB::table('hr_commission_target_types')->truncate();
        DB::table('hr_commission_target_types')->insert([
        ...
        DB::table('hr_payroll_statuses')->truncate();
        DB::table('hr_payroll_statuses')->insert([
        ...
        DB::table('hr_payroll_detail_statuses')->truncate();
        DB::table('hr_payroll_detail_statuses')->insert([
        ...
        DB::table('hr_gratuity_payout_statuses')->truncate();
        DB::table('hr_gratuity_payout_statuses')->insert([
            ['id' => 1, 'name' => 'Pending',  'created_at' => now(), 'updated_at' => now()],
            ['id' => 2, 'name' => 'Approved', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 3, 'name' => 'Paid',     'created_at' => now(), 'updated_at' => now()],
        ]);

        DB::table('hr_leave_types')->truncate();
        ...
        DB::table('hr_payslip_item_types')->truncate();
        DB::table('hr_payslip_item_types')->insert([
        ...
        DB::table('hr_attendance_statuses')->truncate();
        DB::table('hr_attendance_statuses')->insert([
        ...
        DB::table('hr_ticket_types')->whereIn('id', [1, 2, 3])->delete();
        DB::table('hr_ticket_types')->insert([
        ...
        DB::table('hr_ticket_statuses')->truncate();
        DB::table('hr_ticket_statuses')->insert([
            ['id' => 1, 'name' => 'Pending',  'created_at' => now(), 'updated_at' => now()],
            ['id' => 2, 'name' => 'Approved', 'created_at' => now(), 'updated_at' => now()],
        ...
        DB::table('hr_employee_account_types')->truncate();
        DB::table('hr_employee_account_types')->insert([
        ...
        DB::table('hr_petty_cash_heads')->whereIn('id', [1])->delete();
        DB::table('hr_petty_cash_heads')->insert([
